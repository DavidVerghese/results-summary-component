function Score({score,rank, percentile}){
	return (
		<div className="w-full sm:max-w-sm">
			<div className="bg-gradient-to-r from-indigo-800 via-indigo-600 to-indigo-800 text-white shadow-2xl rounded-b-2xl sm:rounded-t-2xl flex flex-col items-center p-8">
